...
public class ProExcelTool
{
    /// <summary>
    /// excel文件存放的路径
    /// </summary>
    public static string EXCEL_PATH = Application.dataPath + "/" + ProConst.ExcelFilePath;

    /// <summary>
    /// 数据结构类脚本存储位置路径
    /// </summary>
    public static string DATA_CLASS_PATH = Application.dataPath + "/" + ProConst.ExcelDataClassPath;

    /// <summary>
    /// 容器类脚本存储位置路径
    /// </summary>
    public static string DATA_CONTAINER_PATH = Application.dataPath + "/" + ProConst.ExcelContainerPath;

    private static string streamingAssetsPath => $"{Application.streamingAssetsPath}/{ProConst.BinaryDataPath}";

    private static string persistentDataPath => $"{Application.persistentDataPath}/{ProConst.BinaryDataPath}";
    ...
    [MenuItem("ProFramework/GenerateExcelInfo")]
    private static void GenerateExcelInfo()
    {
        ...
        for (int i = 0; i < fileInfoArray.Length; i++)
        {
            ...
            {
                //生成数据结构类
                GenerateExcelDataClass(dataTable);
                //生成容器类
    ...
    private static void GenerateExcelDataClass(DataTable dataTable)
    {
        ...
        //把拼接好的字符串存到指定文件中去
        File.WriteAllText(DATA_CLASS_PATH + dataTable.TableName + ".cs", str);
    ...
    private static void GenerateExcelContainer(DataTable table)
    {
        ...
        str += "dataClassDictionary = new " + "Dictionary<" + rowType[keyIndex].ToString() + ", " + table.TableName + ">();\n";
