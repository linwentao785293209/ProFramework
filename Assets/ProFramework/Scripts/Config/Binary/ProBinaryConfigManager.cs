...
{
    public class ProBinaryConfigManager : ProSingletonInSystem<ProBinaryConfigManager>
    {
        private string streamingAssetsPath => $"{Application.streamingAssetsPath}/{ProConst.BinaryConfigsPath}";
        ...
        private ProBinaryConfigManager()
        {
        }
