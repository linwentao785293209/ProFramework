        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.W))
            {
                ...
                ProEditorResourceManager.Instance.LoadEditorResource<Material>(
                    $"{ProConst.EditorAssetBundlePath}{ProConst.Materials}/BlueMaterialTest.mat",
                    (material) =>
                    {
                        if (material != null)
                        {
            ...
            {
                // 加载纹理
                ProEditorResourceManager.Instance.LoadEditorResource<Texture>($"{ProConst.EditorAssetBundlePath}{ProConst.Textures}/head.png",
                    (texture) =>
                    {
                        if (texture != null)
                        {
            ...
            if (Input.GetKeyDown(KeyCode.T))
            {
                Dictionary<string, Sprite> spriteDictionary =
                    ProEditorResourceManager.Instance.LoadSpritesDictionaryInAtlas($"{ProConst.Textures}/AtlasTest");
