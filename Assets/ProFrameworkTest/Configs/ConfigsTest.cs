...
namespace ProFramework
{
    public class ConfigsTest : MonoBehaviour
    {
        ...
        {
            // 加载并打印第一个数据容器
            ProBinaryConfigManager.Instance.LoadExcelTable<ProFrameworkTestInfoContainer, ProFrameworkTestInfo>();
            ProFrameworkTestInfoContainer proFrameworkTestInfoContainer =
                ProBinaryConfigManager.Instance.GetExcelTable<ProFrameworkTestInfoContainer>();
            PrintDataContainer(proFrameworkTestInfoContainer);

            // 加载并打印第二个数据容器
            ProBinaryConfigManager.Instance.LoadExcelTable<ProFrameworkTestInfo2Container, ProFrameworkTestInfo2>();
            ProFrameworkTestInfo2Container proFrameworkTestInfo2Container =
                ProBinaryConfigManager.Instance.GetExcelTable<ProFrameworkTestInfo2Container>();
